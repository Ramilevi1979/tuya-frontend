...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState('devices'); // 'devices' או 'automations'
  ...
  const [newAuto, setNewAuto] = useState({
    ...
    value: true,
    time: '07:00',
    days: [0, 1, 2, 3, 4, 5, 6], // כל השבוע
    durationMinutes: 45 // כיבוי אוטומטי אחרי 45 דקות
  });
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', padding: '20px', maxWidth: '650px', margin: '0 auto', direction: 'rtl' }}>
      ...
      {/* תפריט ניווט בין מכשירים לאוטומציות */}
